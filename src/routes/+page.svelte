...
<div class="hero lg:w-screen h-screen mx-auto items-center justify-center flex flex-col">
    <div class="flex flex-col lg:flex-row justify-center items-center">
        ...
        <div class="flex-col items-center justify-center">
            <!-- <h1 class="text-7xl font-bold h-20 drop-shadow bg-gradient-to-r from-blue-400 via-teal-400 to-emerald-400 text-transparent bg-clip-text"> StudyZone</h1> -->
            <h1 class="text-4xl lg:text-7xl font-bold drop-shadow text-zinc-600 dark:text-white"> StudyZone </h1>

            <p class="lg:text-lg text-zinc-300 mb-8 font-semibold drop-shadow-sm"> Your personalized <span class="font-bold bg-gradient-to-r from-purple-400 via-blue-400 to-cyan-300 text-transparent bg-clip-text">AI-powered</span> study room</p>
        </div>
    </div>
    ...
    <div class="lg:absolute flex flex-col lg:flex-row w-96 lg:w-fit lg:gap-4 xl:-gap-16 bottom-0 lg:m-20 items-center justify-center dark:stroke-white dark:text-white">
        <div class="flex flex-row gap-2 p-4 ">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 15.75l5.159-5.159a2.25 2.25 0 013.182 0l5.159 5.159m-1.5-1.5l1.409-1.409a2.25 2.25 0 013.182 0l2.909 2.909m-18 3.75h16.5a1.5 1.5 0 001.5-1.5V6a1.5 1.5 0 00-1.5-1.5H3.75A1.5 1.5 0 002.25 6v12a1.5 1.5 0 001.5 1.5zm10.5-11.25h.008v.008h-.008V8.25zm.375 0a.375.375 0 11-.75 0 .375.375 0 01.75 0z" />
            </svg>
            <p> Choose your preferred asthetic </p>
        </div>
        ...
        <div class="flex flex-row gap-2 p-4">
            ...
            <p> Select your favourite tune </p>
        </div>
        ...
        <div class="flex flex-row gap-2 p-4">
            ...
            <p> Get help from our chatbot <span class="text-xs font-black bg-gradient-to-r from-red-400 to-orange-400 text-transparent bg-clip-text text-center self-center">PRO</span></p>
        </div>
    </div>
</div>
