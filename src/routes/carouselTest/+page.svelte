...
<main>
    <main>
        <ul>
          <li>
            <article style="--bg: url(https\:\/\/picsum\.photos\/600\/800\?random\=0);" id="explore">
              <a href="#explore" on:click={scrollIntoView}>
                <span><span class="word"><span>EXPLORE</span></span></span>
              </a>
            </article>
          </li>
          <li>
            <article style="--bg: url(https\:\/\/picsum\.photos\/600\/800\?random\=1);" id="move">
              <a href="#move" on:click={scrollIntoView}>
                <span><span class="word"><span>MOVE</span></span></span>
              </a>
            </article>
          </li>
          <li>
            <article style="--bg: url(https\:\/\/picsum\.photos\/600\/800\?random\=2);" id="breathe">
              <a href="#breathe" on:click={scrollIntoView}>
                <span><span class="word"><span>BREATHE</span></span></span>
              </a>
            </article>
          </li>
          <!-- <li>
            <article href="#love" style="--bg: url(https\:\/\/picsum\.photos\/600\/800\?random\=3);" id="love">
              <a href="#explore" on:click={scrollIntoView}>
          ...
          <li>
            <article style="--bg: url(https\:\/\/picsum\.photos\/600\/800\?random\=5);" id="relax">
              <a href="#">
